...
void setup() {
  ...
  server.on("/clock/off", HTTP_GET, [](AsyncWebServerRequest *request)
  {
    //motor1
    digitalWrite(direction_motor1, LOW);
    digitalWrite(value_motor1, LOW);
  ...
  server.on("/anticlock/off", HTTP_GET, [](AsyncWebServerRequest *request)
  {
    //motor1
    digitalWrite(direction_motor1, LOW);
    digitalWrite(value_motor1, LOW);
  ...
  server.on("/leftfront/off", HTTP_GET, [](AsyncWebServerRequest *request)
  {
    //motor1
    digitalWrite(direction_motor1, LOW);
    digitalWrite(value_motor1, LOW);
  ...
  server.on("/rightfront/off", HTTP_GET, [](AsyncWebServerRequest *request)
  {
    //motor1
    digitalWrite(direction_motor1, LOW);
    digitalWrite(value_motor1, LOW);
  ...
  server.on("/leftrear/off", HTTP_GET, [](AsyncWebServerRequest *request)
  {
    //motor1
    digitalWrite(direction_motor1, LOW);
    digitalWrite(value_motor1, LOW);
  ...
  server.on("/rightrear/off", HTTP_GET, [](AsyncWebServerRequest *request)
  {
    //motor1
    digitalWrite(direction_motor1, LOW);
    digitalWrite(value_motor1, LOW);
